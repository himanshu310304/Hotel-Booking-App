                ...
                <tbody className='text-sm'>
                    {dashboardData.bookings.map((item, index) => (
                        <tr key={index}>
                            ...
                            <td className='text-center py-3 px-4 border-t border-gray-300'>
                                <span className={`inline-block py-1 px-3 text-xs rounded-full ${item.isPaid ? 'bg-green-200 text-green-900' : 'bg-amber-200 text-yellow-600'}`}>
