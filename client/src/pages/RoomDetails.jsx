  ...
  return  room && (
    ...
    {/* Room Details */}
        ...
        <div className='flex flex-col md:flex-row md:justify-between mt-10'>
            ...
            <form className='flex flex-col md:flex-row md:items-center justify-between bg-white 
                    shadow-[0_0_20px_rgba(0,0,0,0.15)] p-6 rounded-xl w-full max-w-6xl mx-auto mt-16'>
